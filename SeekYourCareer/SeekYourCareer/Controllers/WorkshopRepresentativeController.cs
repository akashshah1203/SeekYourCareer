...
{
    [Authorize]
    public class WorkshopRepresentativeController : Controller
    {
        //
        // GET: /WorkshopRepresentative/
        [HttpGet]
        public ActionResult WorkshopCandidateByCompany()
        {
        ...
        [HttpPost]
        public ActionResult WorkshopCandidates(int wid)
        {
        ...
        [HttpGet]
        public ActionResult WorkshopApplicantByCompany()
        {
            string type = (string)Session["TypeOfUser"];
            if (type == null)
            {
        ...
        [HttpPost]
        public ActionResult WorkshopApplicantIdList(string domain)
        {
            string repName = (string)(Session["Username"]);
        ...
        [HttpPost]
        public ActionResult WorkshopPrerequisite(string wid)
        {
        ...
        //
        // GET: /WorkshopRepresentative/Details/5
        ...
        //
        // GET: /WorkshopRepresentative/Create
        ...
        //
        // POST: /WorkshopRepresentative/Create
        ...
        //
        // GET: /WorkshopRepresentative/Edit/5
        ...
        //
        // POST: /WorkshopRepresentative/Edit/5
        ...
        //
        // GET: /WorkshopRepresentative/Delete/5
        ...
        //
        // POST: /WorkshopRepresentative/Delete/5
